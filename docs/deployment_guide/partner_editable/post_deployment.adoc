...
[start=8]
. Verify that the DNS entry successfully resolves by running `nslookup``. Navigate to *Start* and enter `cmd`. In the command line, enter the following:

Nslookup *mail*._example.com_

_______________________________________________________________________________________________________________
Where mail is the name of the CNAME record you created, and *example.com* is the domain name of your Active Directory.
_______________________________________________________________________________________________________________
